 ...
 */
final class Version20190426134015 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, title AFTER `created_at`, description LONGTEXT NOT NULL, active_time_start TIME NOT NULL, active_time_end TIME NOT NULL, transport TINYINT(1) NOT NULL, education TINYINT(1) NOT NULL, cleaning TINYINT(1) NOT NULL, coordinate_x NUMERIC(10, 0) NOT NULL, coordinate_y NUMERIC(10, 0) NOT NULL, INDEX IDX_E19D9AD2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
