 ...
 */
final class Version20190427061252 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service ADD service_type VARCHAR(255) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service DROP service_type, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
