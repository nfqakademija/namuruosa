 ...
 */
final class Version20190528092011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reports (id INT AUTO_INCREMENT NOT NULL, reporter_user_id INT NOT NULL, reported_user_id INT NOT NULL, report LONGTEXT NOT NULL, created_at DATETIME NOT NULL, solved_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
