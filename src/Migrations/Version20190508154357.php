 ...
 */
final class Version20190508154357 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_profile ADD job_title VARCHAR(255) NOT NULL, ADD photo VARCHAR(255) NOT NULL, ADD languages VARCHAR(255) NOT NULL, ADD skill VARCHAR(255) NOT NULL, ADD hour_price INT NOT NULL, ADD phone VARCHAR(255) NOT NULL, CHANGE user_id_id user_id_id INT DEFAULT NULL');
    }
